export const en = {
  brand: "Sheikh Al Kar",
  tagline: "Authentic restaurant operations",
  signIn: "Sign in",
  email: "Email address",
  password: "Password",
  welcomeBack: "Welcome back",
  loginHint: "Enter your account details to continue.",
  ...
  salesCategory: "Sales by category",
  ...
  discount: "Discount",
  total: "Total",
  checkout: "Complete cash payment",
  emptyCart: "Your cart is empty",
  emptyCartHint: "Tap a product to start an order.",
  customize: "Customize",
  size: "Choose size",
  addons: "Add extras",
  ...
  profitByEmployee: "Profit by employee",
  ingredientCosting: "Ingredient costing",
